...
**Comment:** From the summary we can see that the p-value for the coefficient of the variable 'sex' is almost 0.7 which is significantly high(>>0.05), specifying that it doesn't affect the response variable 'charges'. So now we will rebuild the model droping the variable 'sex'.
